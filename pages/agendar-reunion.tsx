                  ...
                  <>
                          ...
                          <div className="min-h-screen flex items-center justify-center bg-white px-6">
                                    <div className="max-w-md w-full text-center">
                                      ...
                                      {successData && (
                                  <div className="bg-[#f6f9fc] border border-gray-200 rounded-lg p-4 text-left mb-4">
                                                  <p className="text-sm font-semibold text-gray-800 mb-2">Detalles de tu reunion:</p>p>
                                                  <p className="text-sm text-gray-600">
                                                                    <span className="font-medium">Tu hora ({successData.userTimezone}):</span>span><br />
                                                    {successData.horaUsuario}
                                                  </p>p>
                                    {successData.userTimezone !== 'Europe/Madrid' && (
                                                      <p className="text-sm text-gray-400 mt-1">
                                                                          <span className="font-medium">Hora en Espana:</span>span> {successData.horaMadrid}
                                                      </p>p>
                                                  )}
                                  </div>div>
                                                )}
          ...
          <>
                ...
                <div className="w-full bg-white">
                        <div className="max-w-[700px] mx-auto px-6 py-20 md:py-28">
                          ...
                          <p className="text-xs text-[#6096B9] mt-2 bg-blue-50 inline-block px-3 py-1 rounded-full">
                                          Los horarios se muestran en hora de Espana (Europe/Madrid). Tu hora local se mostrara al confirmar.
                          </p>p>
                                              )}
                                  </div>div>
