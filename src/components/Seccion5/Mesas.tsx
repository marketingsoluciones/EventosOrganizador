...
import { ModalMesas } from "./Modales/ModalMesas";
...
<div className="w-auto flex md:flex-row flex-col items-start justify-start gap-[16px]">
  ...
  <div className="h-auto md:flex-[0.75] flex flex-row items-start justify-start py-0 px-4 box-border bg-cover bg-no-repeat bg-[top] max-w-full ">
    <img src="https://imagedelivery.net/EfbdVs7eFECYhyroHhep9w/0320848a-f732-44ad-fd6e-f6eaf1765100/public" alt="" />
  </div>
  ...
  <div className="md:flex-1 flex flex-col items-start justify-start pt-5 px-0 pb-0 box-border max-w-full">
    <div className="self-stretch flex flex-col items-start justify-start gap-[20px]">
      ...
      <div className="self-stretch  h-auto relative leading-[24px] flex flex-col gap-4 items-center md:text-[18px] text-sm">
          ...
          <p className="m-0 font-light">
          Esta información se puede compartir con el proveedor de catering y los otros profesionales que participen en esta área del evento. Permite acceder a la ubicación de cada asistente a  través de tablas descargables.
          </p>
...
</div>
{
  addInfo ? (
      ...
      classe={"w-[56%] h-[86%]"}>
          ...
          <ModalMesas addInfo={addInfo} setAddInfo={setAddInfo} />
      </Modal>
  ) :
      null
}
