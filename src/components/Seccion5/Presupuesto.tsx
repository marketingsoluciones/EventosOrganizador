...
import { ModalPresupuesto } from "./Modales/ModalPresupuesto";
...
const Presupuesto1: FC<props> = ({componentState, setComponentState}) => {
...
<div className="w-auto flex md:flex-row flex-col items-start justify-start md:gap-[65px] gap-[16px]">
  ...
  <div className="h-auto md:flex-[0.75] flex flex-row items-start justify-start py-0 px-4 box-border bg-cover bg-no-repeat bg-[top] max-w-full ">
    <img src="https://imagedelivery.net/EfbdVs7eFECYhyroHhep9w/499525b2-b451-438e-880f-7ba54d06dd00/public" alt="" />
  </div>
  ...
  <div className="md:flex-1 flex flex-col items-start justify-start pt-5 px-0 pb-0 box-border max-w-full">
    <div className="self-stretch flex flex-col items-start justify-start gap-[20px]">
      ...
      <div className="self-stretch  h-auto relative leading-[24px] flex flex-col gap-4 items-center md:text-[18px] text-sm">
          ...
          Manejo intuitivo de la administración del presupuesto.
        Posee una interfaz sencilla diseñada para centralizar y organizar los gastos operativos en un solo lugar. 
          </p>

          <p className="m-0 font-light">
          Permite ajustar automatizaciones como recordatorios de gastos y más.
          </p>
...
</div>
{
  addInfo ? (
      ...
      classe={"w-[56%] h-[86%]"}>
          ...
          <ModalPresupuesto addInfo={addInfo} setAddInfo={setAddInfo} />
      </Modal>
  ) :
      null
}
