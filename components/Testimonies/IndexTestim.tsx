...
const Testimonies: FC = () => {
  ...
  return (
<div className="w-[100%] flex flex-col bg-[#F7F9FA] items-center justify-center py-20 md:px-12 px-3 box-border max-w-[1200px] mx-auto">
      <div className="flex flex-col items-center justify-start gap-12 relative">
        ...
        <div className="flex md:flex-row flex-col items-start justify-start md:gap-12 gap-6 z-50">
          {DataCard.map((item, idx) => (
            <div key={idx} className="relative">
              {idx === 0 && (
                <div className="absolute -left-24 -top-14 text-[#E2E3E4] md:block hidden z-0">
