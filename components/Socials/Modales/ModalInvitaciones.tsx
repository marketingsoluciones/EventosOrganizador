...
interface propsModalInvitaciones {
    addInfo:any
    setAddInfo:any
}

export const ModalInvitaciones: FC <propsModalInvitaciones> = ({addInfo,setAddInfo}) => {
    return (
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-5 max-w-full">
            <div className="self-stretch flex flex-col items-start justify-start">
              <b className="self-stretch relative md:tracking-[1px] md:leading-[48px] leading-6 md:text-[28px] text-[18px] text-[#6096B9] ">
                Entregas de invitaciones en tiempo récord
              </b>
            </div>
            ...
            <p>Envío ágil de las invitaciones a través de las múltiples opciones en canales de envío. Email, WhatsApp o SMS.
            </p>
            <p>Los cambios se reflejan de forma automática en la lista de invitados del evento.
            </p>
              </div>
            </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3"></path>
          ...
          <div className="self-stretch flex flex-col items-center justify-start py-0 px-4">
            <img
              ...
              loading="lazy"
              alt=""
              src="https://imagedelivery.net/EfbdVs7eFECYhyroHhep9w/362ee5df-95ae-440e-8b7d-b89d7c134700/public"
            />
          </div>
        </div>
        </div>
        ...
        <div className="self-stretch flex flex-col items-start justify-center gap-4 box-border max-w-full">
            ...
            <div className="flex flex-col items-start justify-start gap-5 max-w-full">
              ...
              <div className="flex flex-col items-start justify-start md:text-[24px] text-[18px] leading-[20px] text-black font-bold">
                ...
                Enlace automático con la lista 
                de invitados
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-1">
                <div className="self-stretch flex flex-col items-start justify-start">
                  <div className="self-stretch relative md:leading-[24px] leading-4 font-medium">
                    Al compartir la invitacion el invitado puede confirmar asistencia
                  </div>
                </div>
                <div className="self-stretch flex flex-col items-start justify-start text-steelblue-100">
                  <div className="self-stretch relative leading-[24px] font-light">
                    Estas automatizaciones en conjunto con la confirmación de asistencia son claves para el trabajo de otros módulos, de aquí se determina el número total de asistentes al evento. 
                  </div>
                </div>
              </div>
            </div>
