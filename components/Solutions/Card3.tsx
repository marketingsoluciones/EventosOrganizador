...
const Card3: FC <Props> = ({items}) => {
  ...
  return (
    <div className='group w-full min-h-[240px] flex flex-col items-center justify-center p-6 rounded-2xl bg-white border border-gray-100 hover:border-[#6096B9] shadow-md hover:shadow-xl transition-all duration-500 hover:scale-105 cursor-pointer relative overflow-hidden'>
